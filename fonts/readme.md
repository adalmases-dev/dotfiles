...
> The script install fonts to the local user only. 
> Optionally, you can parse extra fonts as argument to try to install them (e.g. `./install.sh FiraCode Meslo 0xProto`) 
